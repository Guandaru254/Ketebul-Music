// app/updates/UpdatesContent.tsx
      ...
      <div className="flex flex-col md:flex-row items-center bg-blue-50 border-l-4 border-blue-500 rounded-lg p-6 mb-8 shadow-md">
        ...
        <div className="md:w-2/3">
          ...
          <button
            ...
            // The onClick handler is now safely within a Client Component
            onClick={() => alert("Details for Anyango Nyar Siaya concert are coming soon!")} 
          >
            Get Tickets
          </button>
        </div>
      ...
      <div className="flex flex-col md:flex-row items-center bg-green-50 border-l-4 border-green-500 rounded-lg p-6 shadow-md">
        ...
        <div className="md:w-2/3">
          ...
          <button
            ...
            // The onClick handler is now safely within a Client Component
            onClick={() => alert("Pre-order for 'Shades of Benga' is now open!")}
          >
            Pre-order Now
          </button>
        </div>
